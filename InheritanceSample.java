public class Main
{
	public static void main(String[] args) {
		Student student1 = new Student("Juan", "Camastilisan City Of Calaca, Batangas", "BSIT", 2);
		...
		Staff staff1 = new Staff("De Roxas, Eliza T.", "Camastilisan City Of Calaca, Batangas", "Batangas State University", 499.00f );
